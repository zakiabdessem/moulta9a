...
function Page({ events }: { events: Event[] }) {
  ...
  return (
    <div className="bg-white rounded-md">
      ...
      <div className="bg-white rounded-md">
        {/* {events && <ProductTable blogs={blogs} />} */}
      </div>
    </div>
  )
}
          ...
          events.map((event) => {
            ...
            return (
              <TableRow key={event.id}>
                ...
                <TableCell className="max-h-16 max-w-16">NULL</TableCell>
                ...
                <TableCell className="text-right">
                  ...
                  <Button
                    onClick={() => handleDeleteAnnounce(event.id)}
                    variant="destructive"
                  >
                    <DeleteIcon />
                  </Button>
